  ...
  projects: [
    {
      ...
      name: "Glean · 灵感摘录",
      nameEn: "Glean",
      description: "浏览文章时，常想记下「写得好的一段话 + 脑子里冒出的灵感」，却无处落笔——只能复制到笔记软件再顺手写两句，记录的摩擦太大。<br>做成浏览器插件：选中文本后自动弹出「摘录」按钮，一键摘录并输入灵感；支持云同步与 AI 洞察，帮助使用者了解自己的思维习惯。",
      descriptionEn: "When reading in a desktop browser, I often want to capture a well-written passage and the thought it sparks — Copying into a note-taking app and jot down a fleeting idea, too much friction.<br>I built a browser extension: select text and a &ldquo;Clip&rdquo; button appears; one click saves the excerpt and gives you a field for your thought. Supports cloud sync and AI-powered insights which help users understand their own thinking patterns.",
      year: "2026",
      category: "AI 产品",
    ...
    },
    {
      ...
      name: "抽丝剥茧",
      nameEn: "Unveiling",
      description: "类比分析 Agentic Workflow 搭建 — 将个人思维习惯产品化，通过结构化类比（剥离表面噪音，提取底层机制，在时空不同角落寻找同构案例）来分析问题。<br>拆解为多智能体工作流（结构抽象→搜索生成→查询验证→案例提取→洞察回映），实现从个人认知方法论的产品化。",
